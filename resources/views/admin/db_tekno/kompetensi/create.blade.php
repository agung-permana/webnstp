        ...
        <div class="card-body">
            <form action="{{ route('kompetensi.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama_kompetensi" class="form-control @error('nama_kompetensi') is-invalid @enderror" value="{{ old('nama_kompetensi') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="deskripsi_kompetensi" class="form-control @error('deskripsi_kompetensi') is-invalid @enderror" value="{{ old('deskripsi_kompetensi') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="tugas_unit_kerja" class="form-control @error('tugas_unit_kerja') is-invalid @enderror" value="{{ old('tugas_unit_kerja') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="fungsi_unit_kerja" class="form-control @error('fungsi_unit_kerja') is-invalid @enderror" value="{{ old('fungsi_unit_kerja') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="fasilitas" class="form-control @error('fasilitas') is-invalid @enderror" value="{{ old('fasilitas') }}">
                    @error('fasilitas')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    <label>Telp</label>
                    <input type="number" name="telp" class="form-control @error('telp') is-invalid @enderror" value="{{ old('telp') }}">
                    @error('telp')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
