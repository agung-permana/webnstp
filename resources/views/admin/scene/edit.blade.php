        ...
        <div class="card-body">
            <form action="{{ route('scene.update', $scene->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('scene_id') is-invalid @enderror" name="scene_id" value="{{ old('scene_id', $scene->scene_id) }}">
                    @error('scene_id')
                ...
                <div class="form-group">
                    <label>Zoom</label>
                    <input type="number" class="form-control @error('zoom') is-invalid @enderror" name="zoom" value="{{ old('zoom', $scene->zoom) }}">
                    @error('zoom')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    <label>Title</label>
                    <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ old('title', $scene->title) }}">
                    @error('title')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
