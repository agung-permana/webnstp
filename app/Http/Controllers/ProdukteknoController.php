...
class ProdukteknoController extends Controller
{
    ...
    public function show($id)
    {
        $unit_kerja = Unitkerja::all();
        $kedeputian = Kedeputian::all();
        $produk = Produktekno::find($id);
        return view('admin.db_tekno.produk_tekno.show', compact('unit_kerja', 'kedeputian', 'produk'));
    }
    ...
    public function edit($id)
    {
        ...
        $tkt = Tkt::all();
        $produk = produktekno::find($id);
        return view('admin.db_tekno.produk_tekno.edit', compact('unit_kerja', 'kedeputian', 'tkt', 'produk', 'bidang'));
    }
    ...
    {
        $unit_kerja = Produktekno::find($id);
        $unit_kerja->delete();
